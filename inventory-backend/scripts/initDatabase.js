...
const initializeData = async () => {
  try {
    ...
    const suppliersCount = await r.table('suppliers').count().run();
    
    if (suppliersCount === 0) {
      // Create default suppliers with their specialties
      const defaultSuppliers = [
        {
          supplier_name: 'TechHub Distributors',
          contact_person: 'Roberto Santos',
          email: 'sales@techhub.ph',
        ...
        {
          supplier_name: 'PC Components Pro',
          contact_person: 'Maria dela Cruz',
          email: 'orders@pccomponents.ph',
          phone: '+63 918 234 5678',
          address: 'Quezon City, Metro Manila',
          categories: ['Processors', 'Graphics Cards', 'Motherboards', 'Memory (RAM)', 'Storage'],
          payment_terms: 'Net 15',
          created_at: new Date()
        },
        {
          supplier_name: 'PowerTech Solutions',
          contact_person: 'Juan Reyes',
          email: 'supply@powertech.ph',
          phone: '+63 919 345 6789',
          address: 'Pasig City, Metro Manila',
          categories: ['Power Supply', 'PC Cases', 'Cooling'],
          payment_terms: 'Cash on Delivery',
          created_at: new Date()
        },
        {
          supplier_name: 'Peripherals Plus',
          contact_person: 'Lisa Tan',
          email: 'sales@peripheralsplus.ph',
        ...
        {
          supplier_name: 'Network & Print Supply',
          contact_person: 'Carlos Garcia',
          email: 'info@netprintsupply.ph',
          phone: '+63 921 567 8901',
          address: 'Taguig City, Metro Manila',
          categories: ['Routers', 'Networking', 'Printers', 'Software'],
          payment_terms: 'Net 15',
          created_at: new Date()
        }
      ];

      await r.table('suppliers').insert(defaultSuppliers).run();
    ...
    console.log('\nSuppliers: 5 suppliers created with category specializations');
