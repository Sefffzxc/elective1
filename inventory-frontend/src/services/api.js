...
export const getSuppliersByCategory = (category) => api.get(`/suppliers/by-category/${category}`);
export const addSupplier = (supplier) => api.post('/suppliers', supplier);

// Purchase Orders
export const createPurchaseOrder = (order) => api.post('/purchase-orders', order);
...
export const computeAnalytics = () => api.post('/analytics/compute');
